...
@section('user_registration_menu_class', 'active')
...
@section('main_content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form action="{{ route('admin.users.store') }}" method="post" class="form-horizontal" role="form"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="companyName" placeholder="Company name" name="company_name"
                               class="col-xs-10 col-sm-5" required="" value="{{ old('company_name') }}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="ResellerName" placeholder="Name" name="name"
                               class="col-xs-10 col-sm-5" required="" value="{{ old('name') }}"/>
                        <span class="help-inline col-xs-12 col-sm-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="email" id="EmaileNumber" placeholder="Email" name="email"
                               class="col-xs-10 col-sm-5" required="" value="{{ old('email') }}"/>
                        <span class="help-inline col-xs-12 col-sm-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" id="mobileNumber" placeholder="Phone" name="phone"
                               class="col-xs-10 col-sm-5 input-mask-phone" value="{{ old('phone') }}" required=""/>
                        <span class="help-inline col-xs-12 col-sm-7">
