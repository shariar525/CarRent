...
@section('add_car_menu_class', 'active')
                ...
                <form action="{{ route('admin.cars.store') }}" method="post" class="form-horizontal"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="car_name" value="{{ old('car_name') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="num_of_sits" value="{{ old('num_of_sits') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" max="500" name="price_per_km" value="{{ old('price_per_km') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="car_details" id="" cols="" rows="7" class="form-control"></textarea>
